...
/*** Kernel/userspace different implementations -- Damien Dejean ***/
...
/**
 * Request a growth or a reduction of the heap.
 * Implementation will differ in kernel or user space. On kernel side, will work
 * with the fixed size heap. On user side, it will work with the implementation
 * associated with the program (mostly a syscall).
 */
